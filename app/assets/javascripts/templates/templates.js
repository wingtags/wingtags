...
JST['animal-identifier'] = _.template("<div class='row'><div class='large-12 columns'><label for='animal-identifier'>Tag number</label><input type='number' id='animal-identifier' name='animal-identifier' min='0' max='999' placeholder='Tag number' autofocus></div></div>");
JST['location/address'] = _.template("<div id='address-template'><div class='row'><div class='large-12 columns'><div class='row'><div class='large-12 columns'><label for='suburb'>Suburb</label><input id='suburb' name='suburb' type='text' /></div></div><div class='row'><div class='large-12 columns'><label for='street'>Street</label><input id='street' name='street' type='text' /></div></div></div></div>");
...
JST['location/termscondition'] = _.template("<div class='row'><div class='large-12 columns'><div class='checkbox'><input id='checkbox1' type='checkbox'><label for='checkbox1'>I accept the <a href='/terms'>terms &amp; conditions.</a></label></div></<div></div>");
...
JST['image'] = _.template("\
  <div class='row'> \
    <div class='large-12 columns' id='image-container'> \
